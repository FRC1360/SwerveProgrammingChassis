...
public class RobotContainer {
  ...
  public Command followPath() {
    ...
    Pose2d targetPose = new Pose2d(14.25, 1.92, Rotation2d.fromDegrees(162));
    ...
    return AutoBuilder.pathfindToPose(
        targetPose, constraints, 3.0 // Goal end velocity in meters/sec
        );
  }
}
